...
const VALUES = [
  ...
  { icon: "users" as const, title: "Сообщество", text: "Мы строим комьюнити людей, которым важен стиль и качество вещей." },
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: insets.bottom + 32 }}>
        ...
        <View style={styles.hero}>
          ...
          <Text style={[styles.heroText, { color: colors.mutedForeground }]}>
            Базируясь в Туле — городе мастеров, пряников и самоваров — мы создаём вещи для повседневной жизни. Смелые дизайны, качественные материалы и внимание к каждой детали.
          </Text>
